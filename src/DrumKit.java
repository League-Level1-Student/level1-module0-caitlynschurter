...
public class DrumKit implements MouseListener {
	...
	JLabel drumLabelWithImageCat;
	JLabel drumLabelWithImageDog;
	...
	private void getGoing() throws MalformedURLException {
		...
		jf.setTitle("Dis is a title for a j frame");
		...
		String drumImageString = "Cat Playing Drums.jpg";
		// 9. Edit the next line to use your String variable
		drumLabelWithImageCat = createLabelImage(drumImageString);

		// 10. Add the image to the panel
		jp.add(drumLabelWithImageCat);
		...
		drumLabelWithImageCat.addMouseListener(this);
		// 18. Add more images to make a drumkit. Remember to add this mouse listener to
		// each one.

		drumImageString = "Dog Playing Drums.jpg";
		drumLabelWithImageDog = createLabelImage(drumImageString);
		jp.add(drumLabelWithImageDog);
		jp.setLayout(new GridLayout());
		jf.pack();
		drumLabelWithImageDog.addMouseListener(this);
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (drumClicked == drumLabelWithImageCat) {
			playSound("Drum Sound.wav");
		}
		
		else if(drumClicked == drumLabelWithImageDog) {
