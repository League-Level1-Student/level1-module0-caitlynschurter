...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			String guess = JOptionPane.showInputDialog("who is dis?");
			...
			if (i == 0) {
				if (guess .equals("Arnold")) {
					JOptionPane.showMessageDialog(null, "Dat's correct! U has gained uno point");
					score++;
				} 
				else {
					JOptionPane.showMessageDialog(null, "U is wrong");
				}
			}
			...
			JOptionPane.showMessageDialog(null, "You has " + score + " points!");
